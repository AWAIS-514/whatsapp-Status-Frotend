...
<View style={{backgroundColor:'#00A859',height:60,width:'100%',display:'flex',alignItems:'center',justifyContent:'center'}}>
...
<View style={{width:'100%',height:60,marginTop:6,display:'flex',alignItems:'center',justifyContent:'flex-start',flexDirection:'row',paddingLeft:25}}>
        <Icon2 name="download" color="#fff" style={{fontSize:30}} />
        <Text style={{fontSize:15,marginLeft:7,fontWeight:'bold',color:'#fff'}}>
My Download
        </Text>
        </View>
